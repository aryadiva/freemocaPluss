...
def read_coordinates_from_csv(file_path, x_column, y_column, z_column):
    coordinates = {'x': [], 'y': [], 'z': []}
...
def write_angles_to_csv(list1, list2, list3, list4, list5, list6, list7, list8, list9, list10, out_path):
...
def calculate_angle_deg(x1, y1, z1, x2, y2, z2, x3, y3, z3):
    # Calculate vectors
...
def main():
    ...
    coordinates = read_coordinates_from_csv(file_path, x_column, y_column, z_column)
    ...
    for i in range(len(coordinates['x'])):
        head_angle_degrees = calculate_angle_deg(nose_x_coord[i], nose_y_coord[i], nose_z_coord[i],
        ...
        upper_l_arm_angle_degrees = calculate_angle_deg(l_hip_x_coord[i], l_hip_y_coord[i], l_hip_z_coord[i],
        ...
        upper_r_arm_angle_degrees = calculate_angle_deg(r_hip_x_coord[i], r_hip_y_coord[i], r_hip_z_coord[i],
        ...
        trunk_angle_degrees = calculate_angle_deg(mid_shoulder_x_coord[i], mid_shoulder_y_coord[i], mid_shoulder_z_coord[i],
                                                    mid_hip_x_coord[i], mid_hip_y_coord[i], mid_hip_z_coord[i],
                                                    mid_knee_x_coord[i], mid_knee_y_coord[i], mid_knee_z_coord[i])
        trunk_angles_arr.append(trunk_angle_degrees)

        upper_l_leg_angle_degrees = calculate_angle_deg(l_shoulder_x_coord[i], l_shoulder_y_coord[i], l_shoulder_z_coord[i],
        ...
        upper_r_leg_angle_degrees = calculate_angle_deg(r_shoulder_x_coord[i], r_shoulder_y_coord[i], r_shoulder_z_coord[i],
        ...
        lower_l_arm_angle_degrees = calculate_angle_deg(l_shoulder_x_coord[i], l_shoulder_y_coord[i], l_shoulder_z_coord[i],
                                                    l_elbow_x_coord[i], l_elbow_y_coord[i], l_elbow_z_coord[i],
                                                    l_wrist_x_coord[i], l_wrist_y_coord[i], l_wrist_z_coord[i])
        lower_l_arm_angles_arr.append(lower_l_arm_angle_degrees)
    
        lower_r_arm_angle_degrees = calculate_angle_deg(r_shoulder_x_coord[i], r_shoulder_y_coord[i], r_shoulder_z_coord[i],
                                                    r_elbow_x_coord[i], r_elbow_y_coord[i], r_elbow_z_coord[i],
                                                    r_wrist_x_coord[i], r_wrist_y_coord[i], r_wrist_z_coord[i])
        lower_r_arm_angles_arr.append(lower_r_arm_angle_degrees)

        lower_l_leg_angle_degrees = calculate_angle_deg(l_hip_x_coord[i], l_hip_y_coord[i], l_hip_z_coord[i],
                                                    l_knee_x_coord[i], l_knee_y_coord[i], l_knee_z_coord[i],
                                                    l_ankle_x_coord[i], l_ankle_y_coord[i], l_ankle_z_coord[i])
        lower_l_leg_angles_arr.append(lower_l_leg_angle_degrees)
    
        lower_r_leg_angle_degrees = calculate_angle_deg(r_hip_x_coord[i], r_hip_y_coord[i], r_hip_z_coord[i],
                                                    r_knee_x_coord[i], r_knee_y_coord[i], r_knee_z_coord[i],
                                                    r_ankle_x_coord[i], r_ankle_y_coord[i], r_ankle_z_coord[i])
        lower_r_leg_angles_arr.append(lower_r_leg_angle_degrees)

    write_angles_to_csv(head_angles_arr, trunk_angles_arr, upper_l_arm_angles_arr, upper_r_arm_angles_arr, upper_l_leg_angles_arr, 
